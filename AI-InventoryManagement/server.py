...
def dashboard(request: Request):
    charts = os.listdir(REPORTS_PATH) if os.path.exists(REPORTS_PATH) else []
    summary = {"Total Productos": 0, "Categorías": 0, "Stock Promedio": 0, "Valor Total": "$0"}
    return templates.TemplateResponse("dashboard.html", {"request": request, "summary": summary, "charts": charts})
